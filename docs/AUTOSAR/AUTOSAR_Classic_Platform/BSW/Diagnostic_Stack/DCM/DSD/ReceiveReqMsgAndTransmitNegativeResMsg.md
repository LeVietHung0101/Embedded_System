...
<figure>
  <img
    src="{{ site.baseurl }}\assets\images\AUTOSAR\DCM\DSD\GeneralServerResponseBehaviour.png"
...
<figure>
  <img
    src="{{ site.baseurl }}\assets\images\AUTOSAR\DCM\DSD\GeneralServerResponseBehaviourForReqtMsgWithSubFuncPara.png"
    alt="suppressPosRspMsgIndicationBit (SPRMIB)"
  />
