...
<figure class="figure-grid">
  <div class="image-row">
    <img
      src="{{ site.baseurl }}\assets\images\UDS\OBDII_port_on_vehicle.png"
      alt="Vị trí cổng OBD-II trên xe"
    />
    <img
      src="{{ site.baseurl }}\assets\images\UDS\OBDII_Scaner_BOSCH.png"
...
<figure>
  <img
    src="{{ site.baseurl }}\assets\images\UDS\ODBII_connector_pinout_socket.svg"
...
<figure>
  <img
    src="{{ site.baseurl }}\assets\images\UDS\UDS-Unified-Diagnostic-Services-OSI-Model-7-Layer.svg"
