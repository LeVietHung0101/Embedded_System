...
Refer: [Embedded Systems Engineering Roadmap](https://github.com/m3y54m/embedded-engineering-roadmap)
...
<table class="hover-table">
  <thead>
    <tr>
      ...
      <th>Automotive core</th>
      <th>AUTOSAR Classic platform</th>
      <th>Priority</th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
      <td>Embedded Systems Architecture</td>
      <td>Memory</td>
      <td>✅</td>
      <td>⚪</td>
      <td>✅</td>
    ...
    <tr>
      <td>Interfaces, Protocols & Communication Technologies</td>
      <td>UART</td>
      <td>⚪</td>
      <td>⚪</td>
      <td>✅</td>
...
<table class="hover-table">
  ...
  <tbody>
    <tr>
      <td><a href="https://vi.wikipedia.org/wiki/CPU" target="_blank">CPU</a></td>
      <td>Central Processing Unit</td>
      <td>Bộ xử lý trung tâm: là "bộ não" của mọi hệ thống máy tính. CPU chịu trách nhiệm thực thi các lệnh, tính toán và xử lý mọi luồng dữ liệu của thiết bị.</td>
    </tr>
    <tr>
      <td>PSU</td>
      <td>Power Supply Unit</td>
      <td>Thiết bị phần cứng có nhiệm vụ chuyển đổi dòng điện xoay chiều (AC) thành dòng điện 1 chiều (DC).</td>
    </tr>
    <tr>
      <td>PC</td>
      <td>Personal Computer</td>
      <td>Máy tính cá nhân là thiết bị điện tử được thiết kế để sử dụng cho từng cá nhân nhằm phục vụ các nhu cầu cơ bản như làm việc, học tập, giải trí (chơi game, xem phim) và thiết kế.</td>
    </tr>
  </tbody>
</table>
...
- https://www.nextpcb.com/blog/understanding-the-differences-between-cpu-mcu-mpu-soc-dsp-ecu-gpu-and-fpga
- https://www.ersaelectronics.com/blog/microcontrollers-vs-processors-key-differences-and-applications?srsltid=AfmBOopU6NmKIVq7RgpZ6o3cxCnN-_1QTUipA206eF2CYY0GHfO_6q7U
- https://www.renesas.com/en/support/engineer-school/mcu-01-basic-structure-operation?srsltid=AfmBOopm24hARn5F6WhFjSua2sbmCer-lOx9hC5o4uN9PIaO6aro96GV
- https://www.pcb-hero.com/blogs/lickys-column/differences-between-cpu-mpu-mcu-soc
...
│   └── EV Systems
│
├── Embedded Linux & High Performance Systems
│   │
│   ├── Linux Basics
│   ├── Kernel
│   ├── Device Tree
